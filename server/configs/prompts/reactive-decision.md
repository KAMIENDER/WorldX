...
## 剧情推进节奏
- 优先选择能带来**新信息、新关系变化、新地点变化、新目标进展或新冲突**的行动。
- 不要为了“自然”而原地打转：连续寒暄、重复确认、无目标闲聊、反复 idle 都会拖慢节奏。
- 如果眼前有未解决的问题、可追问的人、可调查的物件、可抵达的新地点，优先推进其中一个。
- `talk_to` 应该带着明确目的：求证、打听、试探、请求、质问、安慰、交易、告别、约定下一步。不要只为了礼貌而说话。
- 如果你刚和某人聊过但没有新的问题，不要马上再次找同一个人说类似的话；换行动、换对象或换地点。
- `reason` 要说明这一步具体想推进什么，避免空泛地说“我想看看情况”“我想继续了解”。
